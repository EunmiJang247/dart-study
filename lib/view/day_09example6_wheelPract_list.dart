...
class TableListWheelList extends StatefulWidget {
  const TableListWheelList({super.key});

  @override
  State<TableListWheelList> createState() => _TableListWheelListState();
}

class _TableListWheelListState extends State<TableListWheelList> {
  //모델 프로퍼티 선언
